  ...
  _.extend(ML.Object.prototype, ML.Events,
    /** @lends ML.Object.prototype */ {
      ...
      _resetCacheForKey: function (key) {
        ...
        if (_.isObject(value) && !(value instanceof ML.Object)) {
     ...
     *   });</pre>
      ...
      save: function (arg1, arg2, arg3) {
        ...
        this._allPreviousSaves = this._allPreviousSaves._continueWith(function () {
          ...
          var request = makeRequest(route, className, model.id, method, json, model);
      ...
      destroy: function (options) {
        ...
        var request =
          ML._request("classes", this.className, this.id, 'DELETE',{}, this);
      ...
      _by_hook: function(){
          this._from_hook = true;
      },

      UseUserPrincipal: function(req){
         var user_principal = JSON.loads(req.headers['ML-User-Principal']);
         if (user_principal.identityType in ['ORG_USER','APP_USER']){
            this._principal['X-LAS-Session-Token'] = user_principal.sessionToken;
         }
        if (user_principal.identityType in ['MASTER_KEY']){
            this._principal['X-LAS-MasterKey'] = user_principal.sessionToken;
        }
        if (user_principal.identityType in ['API_KEY']){
            this._principal['X-LAS-APIKey'] = user_principal.sessionToken;
        }
      },
      UseMasterPrincipal: function(){
         this._principal = {};
      }
  ...
  ML.Object._deepSaveAsync = function (object, model) {
    ...
    return promise.then(function () {
      return ML.Promise._continueWhile(function () {
        ...
        },null).then(function (response, status, xhr) {
            var error;
