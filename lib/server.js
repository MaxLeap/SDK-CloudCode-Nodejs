...
module.exports = function(ML){
    ...
    //测试function
    Cloud.function("zhoucen",function(req, res){
        res.end("zhoucen 是一个帅哥")
    })

    //测试hook
    Cloud.beforeSave('zhoucen', function(req,res){
        console.log("beforeSave");
        res.success();
    });

    Cloud.afterSave('zhoucen', function(req,res){
        console.log("afterSave");
        res.success();
    });

    Cloud.afterUpdate('zhoucen', function(req,res){
        console.log("afterUpdate");
        res.success();
    });

    Cloud.beforeDelete('zhoucen', function(req,res){
        console.log("beforeDelete");
        res.success();
    });

    Cloud.afterDelete('zhoucen', function(req,res){
